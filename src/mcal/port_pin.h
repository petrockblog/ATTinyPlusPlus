...
private:
	...
	typedef reg::register_access<addr_type, reg_type, port, bpos> port_pin_type;
	typedef reg::register_access<addr_type, reg_type, pdir, bpos> port_dir_type;
	typedef reg::register_access<addr_type, reg_type, pinp, bpos> port_inp_type;
