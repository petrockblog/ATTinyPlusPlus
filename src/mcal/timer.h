...
#define TIMER0_SUPPORTS_PHASE_CORRECT_PWM  (1)
	...
	__attribute__((always_inline)) static inline void Timer0_SetToPowerup(
			void) {
	...
	__attribute__((always_inline)) static inline void Timer0_InterruptsOff(
			void) {
		TIMSK &= ~MASK3(OCIE0A, OCIE0B, TOIE0);
	}
...
#define TIMER0_PRESCALER_VALUE_5  (1024)
	...
	__attribute__((always_inline)) static inline void Timer0_SetCompareOutputModeA(
			timer0_com_t com) {
		TCCR0A = (TCCR0A & ~MASK2(COM0A1, COM0A0)) | (com << COM0A0);
	}

	__attribute__((always_inline)) static inline void Timer0_SetCompareOutputModeB(
			timer0_com_t com) {
		TCCR0A = (TCCR0A & ~MASK2(COM0B1, COM0B0)) | (com << COM0B0);
	}

	__attribute__((always_inline)) static inline void Timer0_DisconnectOutputs(
			void) {
...
#define TIMER0_PRESCALE_SET       (1)
	...
	__attribute__((always_inline)) static inline void Timer0_SetOutputCompareMatchAndClear(
			timer0_ocr_t oc) {
		OCR0A = oc;
	}

	__attribute__((always_inline)) static inline void Timer0_SetOutputCompareMatchA(
			timer0_ocr_t oc) {
		OCR0A = oc;
	}

	__attribute__((always_inline)) static inline void Timer0_SetOutputCompareMatchB(
			timer0_ocr_t oc) {
		OCR0B = oc;
	}

	__attribute__((always_inline)) static inline void Timer0_EnableOutputCompareInterruptA(
			void) {
		TIMSK |= (1 << OCIE0A);
	}

	__attribute__((always_inline)) static inline void Timer0_EnableOverflowInterrupt(
			void) {
		TIMSK |= (1 << TOIE0);
	}

	__attribute__((always_inline))  static inline timer0_tcnt_t Timer0_GetCount(
			void) {
		return ( TCNT0);
	}

	__attribute__((always_inline)) static inline void Timer0_SetCount(
			timer0_tcnt_t v) {
		TCNT0 = v;
	}

	__attribute__((always_inline))  static inline uint8_t Timer0_IsOverflowSet(
			void) {
...
#define TIMER1_SUPPORTS_PHASE_CORRECT_PWM  (0)
	...
	__attribute__((always_inline)) static inline void Timer1_SetToPowerup(
			void) {
		// Turn off Clear on Compare Match, turn off PWM A, disconnect the timer from the output pin, stop the clock
		TCCR1 = (0 << CTC1) | (0 << PWM1A) | (0 << COM1A1) | (0 << COM1A0)
	...
	__attribute__((always_inline)) static inline void Timer1_InterruptsOff(
			void) {
		TIMSK &= ~MASK3(OCIE1A, OCIE1B, TOIE1);
	}
...
#define TIMER1_PRESCALER_VALUE_15 (16384)
	...
	__attribute__((always_inline)) static inline void Timer1_ClockSelect(
			timer1_cs_t cs) {
	...
	__attribute__((always_inline)) static inline void Timer1_SetWaveformGenerationMode(
			timer1_wgm_t wgm) {
	...
	__attribute__((always_inline)) static inline void Timer1_SetCompareOutputModeA(
			timer1_com_t com) {
		TCCR1 = (TCCR1 & ~MASK2(COM1A1, COM1A0)) | (com << COM1A0);
	}

	__attribute__((always_inline)) static inline void Timer1_SetCompareOutputModeB(
			timer1_com_t com) {
		GTCCR = (GTCCR & ~MASK2(COM1B1, COM1B0)) | (com << COM1B0);
	}

	__attribute__((always_inline)) static inline void Timer1_DisconnectOutputs(
			void) {
...
#define TIMER1_PRESCALE_SET       (2)
	...
	__attribute__((always_inline)) static inline void Timer1_SetOutputCompareMatchAndClear(
			timer1_ocr_t oc) {
		OCR1A = oc;
		OCR1B = oc;
		OCR1C = oc;
	...
	__attribute__((always_inline)) static inline void Timer1_SetOutputCompareMatchA(
			timer1_ocr_t oc) {
		OCR1A = oc;
	}

	__attribute__((always_inline)) static inline void Timer1_SetOutputCompareMatchB(
			timer1_ocr_t oc) {
		OCR1B = oc;
	}

	__attribute__((always_inline)) static inline void Timer1_EnableOutputCompareInterruptA(
			void) {
		TIMSK |= (1 << OCIE1A);
	}

	__attribute__((always_inline)) static inline void Timer1_EnableOverflowInterrupt(
			void) {
		TIMSK |= (1 << TOIE1);
	}

	__attribute__((always_inline))  static inline timer1_tcnt_t Timer1_GetCount(
			void) {
		return ( TCNT1);
	}

	__attribute__((always_inline)) static inline void Timer1_SetCount(
			timer1_tcnt_t v) {
		TCNT1 = v;
	}

	__attribute__((always_inline))  static inline uint8_t Timer1_IsOverflowSet(
			void) {
